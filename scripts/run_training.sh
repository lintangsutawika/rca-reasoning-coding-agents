...
# CKPT_PATH="ckpts/${MODEL_ALIAS}"
DATA_DIR="data/swe_smith"
CKPT_PATH="ckpts/llm_mini_swe"
...
MINISWE_TRAJ_DIR="mini_swe_agent_trajs"
...
# uv run --isolated -m mini_swe_agent.main_mini_swe \
uv run --isolated -m rca.train \
  ...
  +generator.miniswe_config_path="mini_swe_agent/swebench.yaml" \
